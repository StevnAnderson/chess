...
class TestChess(unittest.TestCase):
    ...
    def test_threatons_Black(self):
        m = src.module.Module()
        queen = m.get((4,1))
        knight = m.get((7,1))
        pawn = m.get((7,2))
        m.moveCheck((5,2), (5,4))
        tList = m.threatonsBlack((6,3))
        try:
    ...
    def test_threatons_White(self):
        ...
        m.turn = 2
        m.moveCheck((5,7), (5,5))
        tList = m.threatonsWhite((6,6))
        try:
            self.assertIn(queen, tList, "queen should threaton F6")
            self.assertIn(knight, tList, "knight should threaton F6")
